...
router.post('/like/:musicId',authMiddleware.loggedInUser, musicController.likeMusic)
// to unlike a music by user 
router.post('/unlike/:musicId',authMiddleware.loggedInUser, musicController.unlikeMusic)
// to get all the music liked by a single user  by id 
router.get('/liked-music/:userId',authMiddleware.loggedInUser, musicController.getLikedMusic)
